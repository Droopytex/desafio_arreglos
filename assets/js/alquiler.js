...
const propiedades_alquiler = [
  ...
  {
    nombre: "Cabaña con hermosa vista al mar",
    src: "https://http2.mlstatic.com/D_NQ_NP_683949-MLC71696675273_092023-O.webp",
    descripcion: "Cabaña totalmente equipada, cerca de la playa ",
    ubicacion: "El Quisco Centro, El Quisco, Valparaíso.",
    habitaciones: 5,
    bathroom: 2,
    costo: 2.5,
    smoke: false,
...
<div class="card">
<img src="${
    propiedades_alquiler[index].src
...
<p><i class="fas fa-map-marker-alt"></i> ${
    propiedades_alquiler[index].ubicacion
  }</p>
 <p>
 <i class="fas fa-bed"></i> ${
   propiedades_alquiler[index].habitaciones
 } Habitaciones |
 <i class="fas fa-bath"></i> ${propiedades_alquiler[index].bathroom} Baños
</p>

<p><i class="fas fa-dollar-sign"></i> ${
    propiedades_alquiler[index].costo * 1000
  }</p>
