...
const propiedades_venta = [
  ...
  {
    nombre: "bella casa en barrio tranquilo y seguro",
    src: "https://http2.mlstatic.com/D_NQ_NP_875852-MLC75296381335_032024-O.webp",
    descripcion:
      "Casa tradicional, con bellas terminaciones, cerca de avenid, supermercados y colegios",
    ubicacion: "Calle Los Fresnos, Miraflores, Viña Del Mar, Valparaíso",
    habitaciones: 4,
    bathroom: 2,
    costo: 2.55,
    smoke: true,
          ...
          <div class="card-body">
            ...
            <p>
              <i class="fas fa-map-marker-alt"></i> ${
                propiedades_venta[index].ubicacion
              }
            </p>

            <p>
              <i class="fas fa-bed"></i> ${
                propiedades_venta[index].habitaciones
              } Habitaciones |
              <i class="fas fa-bath"></i> ${
                propiedades_venta[index].bathroom
              } Baños
            </p>
            <p><i class="fas fa-dollar-sign"></i> ${
              propiedades_venta[index].costo * 1000
            }</p>
